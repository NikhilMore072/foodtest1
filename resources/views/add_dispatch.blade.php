                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-12">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input type="text" class="form-control" name="product_name" id="product_name" ><input type="hidden" name="product_id" id="product_id"></td>
                                                    <td><input type="text" class="form-control" name="category_name" id="category_name" ></td>
                                                    <td><input type="text" class="form-control" name="name" id="manufacturer_name" ></td>
                                                    <td><input type="text" class="form-control" name="prd_unit" id="prd_unit" ></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
