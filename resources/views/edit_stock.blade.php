                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('update_stock') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="vendor_name" class="form-select">
                                    @foreach($vendr as $k => $val)
                                      @if($data['vendor_id'] == $val['id'])
                                      <option value="{{$val['id']}}" selected>{{$val['vendor_name']}}</option>
                                      @else
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="qty" type="number" class="form-control @error('qty') is-invalid @enderror" name="qty" onkeypress="return isNumberKey(event)" value="{{ $data['qty'] }}" required autocomplete="qty">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cost" type="text" class="form-control @error('cost') is-invalid @enderror" name="cost" onkeypress="return isNumberKey(event)" value="{{ $data['cost'] }}" required autocomplete="cost">
                        ...
                        <div class="form-group row">
                            <label for="barcode_id" class="col-md-4 col-form-label text-md-right">{{ __('Barcode') }}</label>

                            <div class="col-md-6">
                                <input id="barcode_id" type="number" class="form-control @error('qty') is-invalid @enderror" name="barcode_id" value="{{ $data['barcode_id'] }}" readonly>
