                ...
                <div class="card-body col-md-6">
                    <form method="POST" action="{{ url('stock_register') }}" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input id="qty" type="number" class="form-control @error('qty') is-invalid @enderror" name="qty" onkeypress="return isNumberKey(event)" value="{{ old('qty') }}" required autocomplete="qty">
                        ...
                        <div>
                            ...
                            <input id="cost" type="number" class="form-control @error('cost') is-invalid @enderror cost" name="cost" onkeypress="return isNumberKey(event)" value="{{ old('cost') }}" onkeypress="return onlyNumberKey(event)" required autocomplete="cost">
                            @error('cost')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
