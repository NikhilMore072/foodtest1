                ...
                @foreach($data as $k =>$v)
                    <tr>
                        ...
                        <td>
                          ...
                          <form action="{{ route('accept.order', $v['id']) }}" method="post" style="display: inline;">
                              @csrf
                              <button type="submit" class="btn btn-success accepted" row_id="{{$v['id']}}" onclick="confirmAccepted('{{ $v['provided_qty'] }}','{{$v['id']}}')">Accept</button>
                          </form>
                      @endif
                            ...
                            <td>
                                @if (!$v['is_accepted'])
                                    <button type="button" class="btn btn-info edit" data-toggle="modal"
                                        data-target=".bd-example-modal-lg" row_id="{{ $v['id'] }}"
                                        onclick="viewOrders('{{ $v['barcode_id'] }}','{{ $v['id'] }}')">Edit</button>
                                    <button type="button" class="btn btn-success accepted" rowid="{{ $v['id'] }}"
                                        onclick="acceptedOrders('{{ $v['provided_qty'] }}','{{ $v['id'] }}')">Accept</button>
                                @endif
                            </td>
                        </tr>
                    @endforeach
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class=" mb-5 mt-3">
                                <div class="row d-flex align-items-baseline">
                                    <div class="col-xl-9">
                                        <p style="color: #7e8d9f;font-size: 20px;">Barcode ID: #<strong
                                                class="order_num"></strong></p>
                                    </div>
                                ...
                                <div class="">
                                    <div class="row my-2 mx-1 justify-content-center">
                                        <div class="form-group row">
                                            <label for="qty"
                                                class="col-md-4 col-form-label text-md-right">{{ __('Received Quantity') }}</label>

                                            <div class="col-md-6">
                                                <input id="qty" type="number" class="form-control qty" name="qty"
                                                    required autocomplete="qty">
                                                <input id="qty_id" type="hidden" class="form-control qty_id"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success submit">Accept</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
